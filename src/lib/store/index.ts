...
export const PAGES_DEFAUT: PageEditable[] = [
  {
    ...
    blocs: [
      ...
      {
        cle: "idee.surtitre",
        label: "Petit titre de la section « L'idée »",
        valeur: "L'idée",
      },
      {
        cle: "idee.phrase",
        label: "Phrase forte de la section « L'idée »",
        aide: "Le gros paragraphe, juste sous le prix de départ.",
        valeur:
      ...
      {
        cle: "idee.texte",
        label: "Paragraphe de la section « L'idée »",
        aide: "Le texte gris sous la phrase forte. Il est précédé automatiquement de l'accroche de la maison.",
        valeur:
      ...
      {
        cle: "arguments.surtitre",
        label: "Petit titre de la section « Le parti-pris »",
        valeur: "Le parti-pris",
      },
      {
        cle: "arguments.titre",
        label: "Titre de la section « Le parti-pris »",
      ...
      },
      {
        ...
        label: "Petit titre du comparatif de prix",
        aide: "Le titre et l'introduction du comparatif, eux, se modifient dans l'écran Contenu.",
        valeur: "Le prix",
      },
      {
        cle: "declinaisons.surtitre",
        label: "Petit titre de la section « Les déclinaisons »",
        valeur: "Les déclinaisons",
      },
      {
        cle: "declinaisons.titre",
        label: "Titre de la section « Les déclinaisons »",
        valeur: "Une maison.\nDeux plans.",
        multiligne: true,
      },
      {
        cle: "declinaisons.texte",
        label: "Paragraphe de la section « Les déclinaisons »",
        valeur:
      ...
      },
      {
        ...
        label: "Petit titre de la section « Notre méthode »",
        valeur: "Notre méthode",
      },
      {
        cle: "methode.titre",
        label: "Titre de la section « Notre méthode »",
