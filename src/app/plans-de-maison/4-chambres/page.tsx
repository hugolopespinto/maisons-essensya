...
export async function generateMetadata(): Promise<Metadata> {
  return resolveMetadata("/plans-de-maison/4-chambres", METADATA_DEFAUT);
}

const METADATA_DEFAUT: Metadata = {
  title: "Maison 4 chambres",
  description: "Nos plans de maison 4 chambres : surfaces, pièces et prix, dans les Landes, en Gironde et au Pays basque.",
  alternates: { canonical: "/plans-de-maison/4-chambres" },
...
export default function Page() {
  return (
    <EnPreparation
      fil={[{ nom: "Accueil", path: "/" }, { nom: "Nos modèles", path: "/maisons" }, { nom: "Maison 4 chambres" }]}
      titre={"Maison 4 chambres"}
      quand={"Les plans de maison à 4 chambres seront réunis ici, avec leur surface, leurs pièces et leur prix."}
